...
var AsaasController = /** @class */ (function () {
    ...
    AsaasController.createCharge = function (req, res, next) {
        return __awaiter(this, void 0, void 0, function () {
            var clientId, documentData, value, installmentValue, installmentDay, paymentType, installmentCount, installmentDate, today, proposedInstallmentDateStr, proposedInstallmentDate, proposedIsAfterToday, proposedIsToday, body, payment, payment, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
